...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnExecuteScript
        '
        Me.btnExecuteScript.Location = New System.Drawing.Point(456, 304)
        Me.btnExecuteScript.Name = "btnExecuteScript"
        Me.btnExecuteScript.Size = New System.Drawing.Size(104, 24)
        Me.btnExecuteScript.TabIndex = 21
        Me.btnExecuteScript.Text = "Execute scripts"
        Me.btnExecuteScript.UseVisualStyleBackColor = True
        '
        'btClear
        '
        Me.btClear.Location = New System.Drawing.Point(456, 343)
        Me.btClear.Name = "btClear"
        Me.btClear.Size = New System.Drawing.Size(104, 24)
        Me.btClear.TabIndex = 22
        Me.btClear.Text = "Nettoyer"
...
#End Region
    ...
    Private Sub InitTriggerHisTable_Process(ByVal sTable As String)
        ...
        sSQL += "BEGIN " + vbCr
        sSQL += "    INSERT INTO " + HisDBName + "..HIS_" + sTable.ToUpper + " (DTHIS, HISACTION, SUser," + sCol.ToUpper + ") " + vbCr
        sSQL += "    SELECT GETDATE(), 'UPD1', SUSER_NAME(), " + sColValue.ToUpper + " FROM DELETED " + vbCr
        sSQL += "    UNION ALL " + vbCr
        sSQL += "    SELECT GETDATE(), 'UPD2', SUSER_NAME(), " + sColValue.ToUpper + " FROM INSERTED " + vbCr
        sSQL += "END " + vbCr
    ...
    Private Sub btnExecuteScript_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExecuteScript.Click
        ...
        '' ''d = New DirectoryInfo(Application.StartupPath & "\Script\Triggers")
        '' ''For Each f As FileInfo In d.GetFiles("*.sql")
        '' ''    RunScriptFile(f.FullName, f.Name)
        '' ''Next

        d = New DirectoryInfo(Application.StartupPath & "\Script\TriggersHis\")
        For Each f As FileInfo In d.GetFiles("*.sql")
            RunScriptFile(f.FullName, f.Name)
        Next
