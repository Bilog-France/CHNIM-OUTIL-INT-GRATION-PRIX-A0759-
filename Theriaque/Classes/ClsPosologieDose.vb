Public Class ClsPosologieDose
    ...
    Public Function TestCoherence_UP_Contenant(ByVal Code_SP As Integer) As Boolean
        ...
        Dim dt As DataTable = cn.MySelect("Select DISTINCT PRE_CDF_UP_CODE_FK from THERIAQUE.PRE_PRESENTATION where PRE_SP_CODE_FK = " & Code_SP & " and len(PRE_CDF_UP_CODE_FK) > 0 ")
