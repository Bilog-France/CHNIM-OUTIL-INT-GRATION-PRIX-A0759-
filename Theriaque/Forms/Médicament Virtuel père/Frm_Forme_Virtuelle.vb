...
#Region " Edit Data  "
    ...
    Private Sub FillCombos()
        Dim query As String = "select FOV_CODE_SQ_PK as code, FOV_LIBELLE as libelle  from  THERIAQUE.FOV_FORME_VIRTUELLE   "
        InitLkup(Me.lstcdf, "FOV_FORME_VIRTUELLE", query, True, True)
    End Sub
