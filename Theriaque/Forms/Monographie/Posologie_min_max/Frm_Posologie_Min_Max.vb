...
Public Class Frm_Posologie_Min_Max1
    ...
    Private Sub Open_Fiche(ByVal CodE1 As Integer)
        ...
        Me.POSOLOGIE_MIN_MAX.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMM_POSOLOGIE_MIN_MAX, _Code)

        Me.CLPH.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMCPH_POSOMINMAX_CLPH, _Code)
        Me.CLCH.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMCCH_POSOMINMAX_CLCH, _Code)
        Me.PROD.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMPR_POSOMINMAX_PROD, _Code)
        Me.SPE.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMSP_POSOMINMAX_SPE, _Code)
        Me.SUBACT.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMSAC_POSOMINMAX_SUBACT, _Code)
        'Me.DOSES.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMDO_POSOMINMAX_DOSES, _Code)
        Me.TERPER.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMTP_POSOMINMAX_TERPER, _Code)
        Me.FPOMMI.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPOMMI_INTERVALLE_MIN_MAX, _Code)
        Me.FPODCM.FillByCode(Me.DsTheriaque_Pos_Min_Max1.FPODCM_DOSE_CUMUL_MAX, _Code)
