...
#End Region
    ...
    Private Sub Frm_Presentation_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        InitLkup(lkupDispMax, CDF_CODIF, strSSQL_CDF_CODIF("33"), True)
...
#Region " Grid View "
    ...
    Private Sub GV2_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs)
        If OnLoading Then
            Exit Sub
        End If
