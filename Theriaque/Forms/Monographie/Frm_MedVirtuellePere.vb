Public Class Frm_MedVirtuellePere
    ...
    Public Overrides Function Chercher() As Boolean
        ...
        If f._Code IsNot Nothing Then
            ...
            MVPRSAV.FillByCode(Me.DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE, f._Code)
            MVPRFOV.FillByCode(Me.DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE, f._Code)
    ...
    Public Overrides Sub Ajouter()
        ...
        Me.DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE.Clear()
        Me.DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE.Clear()
        Me.GC.Enabled = True
    ...
    Public Overrides Sub Valider()
        ...
        Me.BindingContext(Me.DsTheriaque_Nomenclature2, "MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE").EndCurrentEdit()
        MVPRSAV.Update(Me.DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE)

        Me.BindingContext(Me.DsTheriaque_Nomenclature2, "MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE").EndCurrentEdit()
        MVPRFOV.Update(Me.DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE)
    ...
    Public Overrides Sub Annuler()
        ...
        Me.BindingContext(Me.DsTheriaque_Nomenclature2, "MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE").CancelCurrentEdit()
        Me.DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE.RejectChanges()

        Me.BindingContext(Me.DsTheriaque_Nomenclature2, "MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE").CancelCurrentEdit()
        Me.DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE.RejectChanges()
    ...
    Public Overrides Function Supprimer() As Boolean
        ...
        If Not TestFK_Used(MasterTable, "SP_CODE_SQ_PK", txtCode.EditValue) Then
            ...
            For iCount As Integer = 0 To DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE.Rows.Count - 1
                DsTheriaque_Nomenclature2.MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE.Rows(iCount).Delete()
            Next
            MVPRSAV.Update(Me.DsTheriaque_Nomenclature2)

            For iCount As Integer = 0 To DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE.Rows.Count - 1
                DsTheriaque_Nomenclature2.MVPRFOV_MED_VIR_PERE_FORME_VIRTUELLE.Rows(iCount).Delete()
            Next
    ...
    Private Sub Frm_MedVirtuelle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GridControl1.DataMember = "MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE"
    ...
    Private Sub GridView1_InitNewRow(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView1.InitNewRow
        ...
        'Dim m As Integer = Get_MaxCodeIdentity("MVPRSAV_MED_VIR_PERE_SUBSTANCE_VIRTUELLE", "MVPRSAV_NUM_ORD")
