...
#Region " Déclaration des variables privées "
    ...
    Private bModeAjout As Boolean = False
    Private codeDup As String = ""
#End Region
...
#Region " Edit Data  "
    ...
    Private Sub UpdateCodeDupplicat()
        ...
        For iCount As Integer = 0 To dt21.Rows.Count - 1
            dt21.Rows(iCount).Item("FCPMTER_FCPM_CODE_FK_PK") = Me.txtCode.Text
        ...
        For i As Integer = 0 To dt21.Rows.Count - 1
            ...
            TercoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.TERCOM_TERRAIN_COMMENTAIRE, codeDup, dt21.Rows(i).Item("FCPMTER_CDF_TER_CODE_FK_PK"), dt21.Rows(i).Item("FCPMTER_NATURE_CIPEMG_PK"), dt21.Rows(i).Item("FCPMTER_NUMSEQ_PK"))
            NivcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.NIVCOM_NIVEAU_COMMENTAIRE, codeDup, dt21.Rows(i).Item("FCPMTER_CDF_TER_CODE_FK_PK"), dt21.Rows(i).Item("FCPMTER_NATURE_CIPEMG_PK"), dt21.Rows(i).Item("FCPMTER_NUMSEQ_PK"))
            Me.AutcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.AUTCOM_AUTRE_COMMENTAIRE, codeDup, dt21.Rows(i).Item("FCPMTER_CDF_TER_CODE_FK_PK"), dt21.Rows(i).Item("FCPMTER_NATURE_CIPEMG_PK"), dt21.Rows(i).Item("FCPMTER_NUMSEQ_PK"))
            Me.FcpmtX_TA.FillByTerrain(Me.DsTheriaque_Cipemg_Code.FCPMTX_FICHECIPEMG_TEXTE, codeDup, dt21.Rows(i).Item("FCPMTER_CDF_TER_CODE_FK_PK"), dt21.Rows(i).Item("FCPMTER_NUMSEQ_PK"), dt21.Rows(i).Item("FCPMTER_NATURE_CIPEMG_PK"))
    ...
    Public Overrides Sub valider()
        ...
        strSSQL_SP_REF &= " WHERE FCPMSP_FCPM_CODE_FK_PK = " & txtCode.Text
    ...
    Public Overrides Sub Dupliquer()
        ...
        If Not Tab_TA1 And CodE <> InvalideControl And CodE <> Nothing Then LoadTab_1(0)
        If Not Tab_TA2 And CodE <> InvalideControl And CodE <> Nothing Then LoadTab_2()

        codeDup = txtCode.Text
...
#Region " Init Data  "
    ...
    Private Sub InitDataSource()
        ...
        GC23.DataMember = "TERCOM_TERRAIN_COMMENTAIRE"

        GC25.DataSource = DsTheriaque_Cipemg_Code
        GC25.DataMember = "NIVCOM_NIVEAU_COMMENTAIRE"

        GC26.DataSource = DsTheriaque_Cipemg_Code
        GC26.DataMember = "AUTCOM_AUTRE_COMMENTAIRE"

        GC27.DataSource = DsTheriaque_Cipemg_Code
        GC27.DataMember = "FCPMTX_FICHECIPEMG_TEXTE"
    ...
    Private Function ATCDValues() As DataTable
...
#Region " Chargement par onglet "
    ...
    Private Sub LoadTab_1(ByVal bradio As Integer)
        Load_On(Me)
        OnLoading = True
        ...
        If CodE <> InvalideControl And CodE <> Nothing Then
            ...
            If (GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK) IsNot Nothing) Then

                'Me.TercoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.TERCOM_TERRAIN_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
                Me.NivcoM_TA.FillByCode(Me.DsTheriaque_Cipemg_Code.NIVCOM_NIVEAU_COMMENTAIRE, CodE)
                'NivcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.NIVCOM_NIVEAU_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
                Me.AutcoM_TA.FillByCode(Me.DsTheriaque_Cipemg_Code.AUTCOM_AUTRE_COMMENTAIRE, CodE)
                'Me.AutcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.AUTCOM_AUTRE_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
                Me.FcpmtX_TA.FillByCode(Me.DsTheriaque_Cipemg_Code.FCPMTX_FICHECIPEMG_TEXTE, CodE)

                Me.FcpmtX_TA.FillByTerrain(Me.DsTheriaque_Cipemg_Code.FCPMTX_FICHECIPEMG_TEXTE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
...
#Region " New Row "
    ...
    Private Sub GV23_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GV23.InitNewRow
        ...
        GV23.SetFocusedRowCellValue(colTERCOM_FCPM_CODE_FK_PK, txtCode.Text)
        GV23.SetFocusedRowCellValue(colTERCOM_NUMSEQ_TER_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
        GV23.SetFocusedRowCellValue(colTERCOM_CDF_TER_CODE_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK))
        GV23.SetFocusedRowCellValue(colTERCOM_NATURE_CIPEMG_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
    End Sub
    ...
    Private Sub GV25_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GV25.InitNewRow
        ...
        GV25.SetFocusedRowCellValue(colNIVCOM_FCPM_CODE_FK_PK, txtCode.Text)
        GV25.SetFocusedRowCellValue(colNIVCOM_NUMSEQ_TER_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
        GV25.SetFocusedRowCellValue(colNIVCOM_CDF_TER_CODE_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK))
        GV25.SetFocusedRowCellValue(colNIVCOM_NATURE_CIPEMG_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
    ...
    Private Sub GV26_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GV26.InitNewRow
        ...
        GV26.SetFocusedRowCellValue(colAUTCOM_FCPM_CODE_FK_PK, txtCode.Text)
        GV26.SetFocusedRowCellValue(colAUTCOM_NUMSEQ_TER_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
        GV26.SetFocusedRowCellValue(colAUTCOM_CDF_TER_CODE_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK))
        GV26.SetFocusedRowCellValue(colAUTCOM_NATURE_CIPEMG_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
...
#Region " Autres événements "
    ...
    Private Sub GV21_FocusedRowChanged(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GV21.FocusedRowChanged
        If OnLoading Then Exit Sub
        If GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK) IsNot Nothing And GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK) IsNot System.DBNull.Value Then
            Load_On(Me)
            OnLoading = True
            Dim strSSQL_CDF_CIM As String
            strSSQL_CDF_CIM = " SELECT DISTINCT CIM_CODE_PK, CIM_LIBELLE_COURT   "
            ...
            'TercoM_TA.FillByCode(DsTheriaque_Cipemg_Code.TERCOM_TERRAIN_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK))
            'TercoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.TERCOM_TERRAIN_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
            'NivcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.NIVCOM_NIVEAU_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
            'Me.AutcoM_TA.FillByTerrain(DsTheriaque_Cipemg_Code.AUTCOM_AUTRE_COMMENTAIRE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
            'Me.FcpmtX_TA.FillByTerrain(Me.DsTheriaque_Cipemg_Code.FCPMTX_FICHECIPEMG_TEXTE, GV21.GetFocusedRowCellValue(colFCPMTER_FCPM_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK), GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
...
#End Region
    ...
    Private Sub GV27_InitNewRow(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GV27.InitNewRow
        ...
        GV27.SetFocusedRowCellValue(colFCPMTX_FCPM_CODE_FK_PK, txtCode.Text)
        GV27.SetFocusedRowCellValue(colFCPMTX_NUMSEQ_TER_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NUMSEQ_PK))
        GV27.SetFocusedRowCellValue(colFCPMTX_CDF_TER_CODE_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_CDF_TER_CODE_FK_PK))
        GV27.SetFocusedRowCellValue(colFCPMTX_NATURECIPEMG_FK_PK, GV21.GetFocusedRowCellValue(colFCPMTER_NATURE_CIPEMG_PK))
    ...
    Private Sub BindOrigine()
        ...
        If (cmbOrigine.SelectedItem IsNot System.DBNull.Value) Then
