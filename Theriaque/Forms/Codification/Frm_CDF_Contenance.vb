Public Class Frm_CDF_Contenance
    ...
    Public Overrides Sub Valider()
        ...
        If (txtCode.ErrorText.Trim().Equals("")) Then
            ...
            Dim unit As String = ""
            If (lkupUnitref.EditValue IsNot System.DBNull.Value) Then
                unit = lkupUnitref.EditValue
            End If

            If (String.IsNullOrEmpty(unit) And Not String.IsNullOrEmpty(txtFacteur.Text)) Then
                MsgBox("Veuillez saisir le champs unité")
                Exit Sub
            End If

            If (Not String.IsNullOrEmpty(unit) And String.IsNullOrEmpty(txtFacteur.Text)) Then

                MsgBox("Veuillez saisir le champs facteur")
                Exit Sub
            End If
    ...
    Public Overrides Function Supprimer() As Boolean
        ...
        Else
            ...
            cn.Execute("DELETE FROM theriaque.UNITFACTEQ_FACTEUR_EQUIVALENCE WHERE UNITFACTEQ_CDF_CODE_FK_PK='" & txtCode.Text & "' and  UNITFACTEQ_CDF_NUM_FK_PK='" & txtNCodif.Text & "'")
    ...
    Private Sub UpdateUniteRef(ByVal unit As String)
        ...
        Else
            ...
            Else
                exist = " DELETE from theriaque.UNITFACTEQ_FACTEUR_EQUIVALENCE "
                exist &= " where UNITFACTEQ_CDF_CODE_FK_PK='" & txtCode.Text & "' and "
                exist &= " UNITFACTEQ_CDF_NUM_FK_PK='" & txtNCodif.Text & "'"
            End If
        End If
